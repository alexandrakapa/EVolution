...
Supplier.getSessionsbyManID = async (req, result) => {
	...
	dbConn.query(`SELECT Charging.Car_Ownerusername as Car_Owner, MONTH(STR_TO_DATE(Charging.the_date, '%e/%c/%Y %H:%i')) as Month ,SUM(Charging.charging_price) as Total_Charging_Sum
	FROM Charging
